(function () {
    ...
    app.factory('authService', ['common', 'Base64', '$cookieStore', '$http', authService]);

    function authService(common, Base64, $cookieStore, $http) {
        ...
        function setCredentials(username, password) {
            ...
            $cookieStore.put('hackauth', encoded);
        };

        function clearCredentials() {
            document.execCommand('ClearAuthenticationCache');
            $cookieStore.remove('hackauth');
