...
(function () {
    ...
    function timeEntry(common, timeTracking, $routeParams, $scope) {
		...
		function resetBlankTimeEntry(): void {
        ...
        vm.daysOrderBy = (day: any) => -moment(day.dateDisplay);
        ...
        vm.formatToTime = function (datetime: Date, relativeTo: Date) {
            if (datetime) {
                var suffix = "";
                if (relativeTo) {
        ...
        vm.startWork = function (dayEntryDisplay: string) {
        ...
        vm.resumeWork = function (te: TimeEntry) {
        ...
        vm.updateEntry = function (te: TimeEntry, resetBlankDay: boolean, dayEntryDisplay: string) {
            // validate times
        ...
        function convertTimeEntryToDate(dateTimeAsString: string, dayEntryDisplay: string): string {
        ...
        vm.beginEditEntry = function (te: TimeEntry) {
		...
		vm.cancelEditEntry = function (te: any) {
			te.isInEditMode = false;
		}

        vm.deleteEntry = function (te: TimeEntry) {
        ...
        vm.onTimeInSet = function (newDate: Date, te: TimeEntry) {
            te.TimeIn = moment(newDate).format('YYYY-MM-DDTHH:mm:ss');
		}

        vm.onTimeOutSet = function (newDate: Date, te: TimeEntry) {
        ...
        function getTimeEntriesForDate(dateToGet: string) {
